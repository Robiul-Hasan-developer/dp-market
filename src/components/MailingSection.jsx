...
import { billingLists } from '../data/OthersPageData/OthersPageData';
                ...
                <div className="row gy-5">
                    <div className="col-lg-8 pe-sm-5">
                        ...
                        <div className="cart-content__bottom flx-between gap-2">
                            ...
                            <Button
                                btnLink="/cart-payment" 
                                btnClass="btn-main flx-align gap-2 pill btn-lg" 
                    ...
                    <div className="col-lg-4">
                        <div className="order-summary">
                            ...
                            <ul className="billing-list">
                                {
                                    billingLists.map((billingListItem, billingListitemIndex) => {
                                        return (
                                            <li className={`billing-list__item flx-between  ${billingListitemIndex === billingLists.length-1 ? 'text text-heading font-20 fw-500 font-heading' : ''}`} key={billingListitemIndex}>
                                                <span className="text text-heading fw-500">{billingListItem.text}</span>
                                                <span className={`amount text-heading ${billingListitemIndex === 0 ? ' fw-500' : ''}`} >{billingListItem.amount}</span>
                                            </li>
                                        )
                                    })
                                }
