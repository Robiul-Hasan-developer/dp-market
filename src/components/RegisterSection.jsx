            ...
            <div className="row gy-4">
                <div className="col-12">
                    ...
                    <div className="position-relative">
                        <input type="text" className="common-input common-input--bg common-input--withIcon" id="name" onChange={handleUserNameDataChange} placeholder="Your full name"/>
                ...
                <div className="col-sm-12 mb-0">
                    <div className="have-account">
                        <p className="text font-14">Already a member?  <Link to="/login" className="link text-main text-decoration-underline fw-500"> Login</Link>
                        </p>
                    </div>
                </div>
            </div>
